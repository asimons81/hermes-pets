# Archived Hermes Pets v0.5.0 Release Notes

This note file is historical and kept for reference only.

Hermes Pets v0.5.0 shipped as the Codex custom-pet trust release.

This release proved the full operator path for Codex-created desktop pets:
...
- Added source-labeled Codex pet discovery across the local Linux, WSL, and Windows Codex pet stores.
