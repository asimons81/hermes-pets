...
Elon Musk is a curated Hermes Pets custom pet package imported from user-owned Codex pet assets and prepared for repository distribution.
...
![Elon Musk preview sheet](spritesheet.webp)
...
```bash
hermes-pet custom-pet validate docs/custom-pets/elon-musk
hermes-pet custom-pet preview docs/custom-pets/elon-musk --output /tmp/elon-musk-preview.html
```
